...
const questions = [
  ...
  { q:"เวลามีเวลาว่าง คุณมักจะ…",
  c:["อยู่คนเดียวเงียบๆ","จัดระเบียบชีวิต","อื่นๆ","ออกไปหาอะไรสนุกๆ","หาอะไรสุดๆทำแบบไม่คิดมาก"],
  comments:["˙𐃷˙ : อินโทรเวิร์ตตัวจริง","˙𐃷˙ : ชีวิตต้องมีระบบ","˙𐃷˙ : ไม่เป็นไร ไม่ JUDGE","˙𐃷˙ : ชีวิตต้องมีสีสัน","˙𐃷˙ : เอาให้สุดก่อนคิดทีหลัง"]},
